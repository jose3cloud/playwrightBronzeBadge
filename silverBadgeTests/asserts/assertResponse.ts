...
import { SignUpResponse, Contact } from '@pw-silver/utils/types';

/**
 * Asserts a SignUpResponse has the expected schema and key fields.
 */
export function assertSignUpResponse(
  body: SignUpResponse,
...
/**
 * Asserts a Contact has the expected schema and key fields.
 */
